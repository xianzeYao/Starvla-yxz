...
config_yaml=./deployment/train_arx/take_part_bricks/starvla_train_take_part_bricks_qwen3_gr00t.yaml
dataset_root=/mnt/data-alpha-sg-01/team-camera/home/n84416302/dataset
dataset_name=take_part_bricks
data_mix=take_part_bricks
run_root_dir=/home/n84416302/starVLA-yxz/results
run_id=take_part_bricks_qwen3gr00t_50k
num_processes=4
...
modality_template=${script_dir}/take_part_bricks.modality.json
