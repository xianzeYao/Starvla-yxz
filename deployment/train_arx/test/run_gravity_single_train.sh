...
config_yaml=./deployment/train_arx/test/starvla_train_gravity_single_qwen3_gr00t.yaml
dataset_root=/data/yxz
dataset_name=gravity_single4IL
data_mix=gravity_single4il
run_root_dir=/data/yxz/starvla/outputs
run_id=gravity_single4il_qwen3gr00t_10k
num_processes=4
...
modality_template=${script_dir}/gravity_single4IL.modality.json
