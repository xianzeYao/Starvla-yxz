...
freeze_module_list=''
base_vlm=/data/yxz/models/Qwen3-VL-4B-Instruct
config_yaml=./deployment/train_arx/dual_fold_blanket/starvla_train_dual_fold_blanket_qwen3_gr00t.yaml
dataset_root=/data/yxz/datasets
dataset_name=dual_fold_blanket
data_mix=dual_fold_blanket
run_root_dir=/data/yxz/starvla/outputs
run_id=dual_fold_blanket_qwen3gr00t_30k
num_processes=4
...
modality_template=${script_dir}/dual_fold_blanket.modality.json
...
/data/yxz/conda/envs/starVLA/bin/accelerate launch \
